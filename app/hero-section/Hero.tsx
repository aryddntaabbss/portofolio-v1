  ...
  return (
    ...
    >
      ...
      <div className="absolute top-10 flex justify-between sm:w-[90%] lg:max-w-[1440px]">
        <div>
          <Link
            href="https://drive.google.com/file/d/1g_dj8geOFNp2KRZlDzbkhorYqYN7nQeX/view?usp=sharing"
            target="_blank"
      ...
      >
        ...
        >
          <p className="z-50 text-center text-[16px] font-medium text-[#e4ded7] md:text-[20px] lg:text-left">
            Frontend Developer and Product Designer, currently studying Informatics Engineering.
          </p>
        </motion.div>
        ...
        >
          <p className="text-right text-[16px] font-semibold text-[#e4ded7] md:text-[20px]">
            Focused on interfaces and experiences, working remotely from North Molucas, Indonesia.
          </p>
        </motion.div>
      </div>
    </motion.section>
